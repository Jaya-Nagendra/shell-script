...
#For storng an inbuilt function out put in to an variable.
...
#While entering inputs in running time in console these are vissible if we want to hide them while entering in console.
